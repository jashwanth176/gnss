...
const DDMCanvas = dynamic(() => import("@/components/DDMCanvasSimple"), { 
  ssr: false,
  loading: () => (
    <div className="w-[600px] h-[400px] rounded flex items-center justify-center bg-[#F2ECDD] border border-[#84192B]/20">
      <div className="text-black/70">Loading visualization...</div>
    </div>
  )
})
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between mb-8">
            <div className="flex items-center gap-4">
              <Link href="/">
                <Button variant="ghost" size="sm" className="text-black hover:text-[hsl(var(--primary))]">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <Button
                        ...
                        size="sm"
                        variant="outline"
                        className="border-[hsl(var(--primary))]/20 text-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))]/10"
                      >
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className={`border rounded-lg p-3 ${
                        ...
                        <div className="flex gap-2">
                          {dataSource === 'simulation' ? (
                            <Button 
                              size="sm" 
                              variant="outline"
                              className="h-6 text-xs border-[hsl(var(--primary))]/40 text-[hsl(var(--primary))] hover:bg-[hsl(var(--primary))]/10"
                      ...
                      {realDataStatus && (
                        <div className="mt-2 text-xs text-foreground bg-black/5 p-2 rounded border border-[hsl(var(--primary))]/20">
                          {realDataStatus}
                        </div>
                      )}
                    </div>
                    ...
                    <div className="bg-white/70 rounded-lg border border-[hsl(var(--primary))]/20 overflow-hidden">
                      <div className="relative">
                        ...
                        <div className="flex justify-center p-6">
                          <div className="relative">
                            ...
                            {/* Axis Labels */}
                            <div className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 text-muted-foreground text-sm font-medium">
                              Delay (chips)
                            </div>
                            <div className="absolute -left-12 top-1/2 transform -translate-y-1/2 -rotate-90 text-muted-foreground text-sm font-medium">
                              Doppler Frequency (Hz)
                            </div>
                            
                            {/* Color Scale */}
                            <div className="absolute top-4 -right-16 bg-white/90 p-3 rounded border border-[hsl(var(--primary))]/20">
                              <div className="text-foreground text-xs mb-2 text-center">Power</div>
                        ...
                        <div className="absolute bottom-2 left-6 text-xs text-muted-foreground font-mono">
                          0 chips
                        </div>
                        <div className="absolute bottom-2 right-20 text-xs text-muted-foreground font-mono">
                          8 chips
                        </div>
                        <div className="absolute top-4 left-2 text-xs text-muted-foreground font-mono">
                          +250Hz
                        </div>
                        <div className="absolute bottom-16 left-2 text-xs text-muted-foreground font-mono">
                          -250Hz
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-4 gap-4 text-sm">
                      <div className="bg-white/70 p-3 rounded border border-[hsl(var(--primary))]/20">
                        <div className="text-muted-foreground">Time</div>
                        <div className="font-mono text-foreground">{currentTime.toFixed(1)}s</div>
                      </div>
                      <div className="bg-white/70 p-3 rounded border border-[hsl(var(--primary))]/20">
                        <div className="text-muted-foreground">Data Points</div>
                        <div className="font-mono text-foreground">{ddmData.length.toLocaleString()}</div>
                      </div>
                      <div className="bg-white/70 p-3 rounded border border-[hsl(var(--primary))]/20">
                        <div className="text-muted-foreground">Peak Power</div>
                        <div className="font-mono text-foreground">{maxPower.toFixed(1)} dB</div>
                      </div>
                      <div className="bg-white/70 p-3 rounded border border-[hsl(var(--primary))]/20">
                        <div className="text-muted-foreground">Status</div>
                        <div className="text-foreground">{isPlaying ? 'Recording' : 'Paused'}</div>
                      </div>
                    </div>
                  </div>
                </CardContent>
            ...
            <div className="space-y-6">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={surfaceType} onValueChange={setSurfaceType}>
                      <SelectTrigger className="bg-white/70 border-[hsl(var(--primary))]/20 text-foreground">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="font-mono text-foreground">{maxPower.toFixed(1)} dB</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-muted-foreground">Mean Power:</span>
                      <span className="font-mono text-foreground">{meanPower.toFixed(1)} dB</span>
                    </div>
                    {peakLocation && (
                      <>
                        <div className="flex justify-between text-sm">
                          <span className="text-muted-foreground">Peak Delay:</span>
                          <span className="font-mono text-foreground">{peakLocation.delay.toFixed(2)} chips</span>
                        </div>
                        <div className="flex justify-between text-sm">
                          <span className="text-muted-foreground">Peak Doppler:</span>
                          <span className="font-mono text-foreground">{peakLocation.doppler.toFixed(1)} Hz</span>
                        </div>
                      </>
                    )}
                  </div>
              ...
              <Card className="glass-card">
                ...
                <CardContent className="space-y-3">
                  <div className="bg-[hsl(var(--primary))]/10 border border-[hsl(var(--primary))]/30 rounded p-3">
                    <div className="flex items-center gap-2 text-[hsl(var(--primary))] text-sm font-medium mb-1">
                      <Info className="w-4 h-4" />
                      Simulated Data
                    </div>
              ...
              <Card className="glass-card">
                ...
                <CardContent>
                  <div className="text-sm text-muted-foreground leading-relaxed space-y-3">
                    ...
                    <p>
                      <strong className="text-foreground">Ocean:</strong> Shows characteristic patterns due to wave motion.
                    </p>
                    <p>
                      <strong className="text-foreground">Land:</strong> More diffuse scattering with lower coherence.
                    </p>
                  </div>
                </CardContent>
              </Card>
