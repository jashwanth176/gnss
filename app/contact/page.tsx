                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div className="p-4 rounded-lg bg-background/30 border flex items-center gap-4">
                          <div className="relative h-28 w-28 rounded-full overflow-hidden border">
                            <Image src="/yvn.jpg" alt="Prof. YVN Krishnamurthy" fill sizes="112px" className="object-cover" />
                          </div>
                          <div>
                        ...
                        <div className="p-4 rounded-lg bg-background/30 border flex items-center gap-4">
                          <div className="relative h-28 w-28 rounded-full overflow-hidden border">
                            <Image src="/avadh.jpg" alt="Dr. Avardh B Narayan" fill sizes="112px" className="object-cover" />
                          </div>
                          <div>
                        ...
                        <div className="p-4 rounded-lg bg-background/30 border flex items-center gap-4">
                          <div className="relative h-28 w-28 rounded-full overflow-hidden border">
                            <Image src="/ramesh.jpg" alt="Dr. Ramesh Patel" fill sizes="112px" className="object-cover" />
                          </div>
                          <div>
                    ...
                    <CardHeader>
                      <div className="flex items-center justify-between flex-wrap gap-4">
                        <div className="flex items-center gap-4">
                          <div className="relative h-28 w-28 rounded-full overflow-hidden border">
                            <Image src="/roshan.jpg" alt="Dr. Roshan Srivastav" fill sizes="112px" className="object-cover" />
                          </div>
                  ...
                  <Card className="glass-card">
                    <CardHeader>
                      <div className="flex items-center justify-between flex-wrap gap-4">
                        <div className="flex items-center gap-4">
                          <div className="relative h-28 w-28 rounded-full overflow-hidden border">
                            <Image src="/madhavi.jpg" alt="Dr. G Naga Sai Madhavi" fill sizes="112px" className="object-cover" />
                          </div>
                          <CardTitle className="flex items-center gap-3 text-xl">
                            <Users className="h-5 w-5 text-primary" />
                  ...
                  <Card className="glass-card">
                    <CardHeader>
                      <div className="flex items-center justify-between flex-wrap gap-4">
                        <div className="flex items-center gap-4">
                          <div className="relative h-28 w-28 rounded-full overflow-hidden border">
                            <Image src="/jashwanth.jpg" alt="Jashwanth Valurouthu" fill sizes="112px" className="object-cover" />
                          </div>
                          <CardTitle className="flex items-center gap-3 text-xl">
                            <Users className="h-5 w-5 text-primary" />
